...
if __name__ == "__main__":
    ...
    for c_k_led, c_mu_led in zip(c_k, c_mu):
        ...
        for grid_size, num_steps, i in zip(grid_sizes, num_stepss, range(len(grid_sizes))):
            ...
            print("... has finished.")
            n_pp_steps = np.array([num_steps, 5])
            ...
            for pp_interval in pp_intervals:
                ...
                axs1[0].loglog(delta_xs[::2], l2_errors_u[::2], marker="o", markersize=8, color="black", label=f"Exact")
                ...
                axs1[0].legend()
                axs1[1].loglog(delta_xs[::2], l2_errors_sigma[::2], marker="o", markersize=8, color="black", label=f"Exact")
                ...
                plt.savefig(f"{figures_dir}/f_0bound_dirBC_u_sig_L2_ck_ppinterval_test_Npp_ex_{n_pp_steps[1]}")
                ...
                axs2[0].loglog(delta_xs[::2], linf_errors_u[::2], marker="o", markersize=8, color="black", label=f"Exact")
                ...
                axs2[0].legend()
                axs2[1].loglog(delta_xs[::2], linf_errors_sigma[::2], marker="o", markersize=8, color="black", label=f"Exact")
                ...
                plt.savefig(f"{figures_dir}/f_0bound_dirBC_u_sig_LINF_ck_ppinterval_test_Npp_ex_{n_pp_steps[1]}")
                plt.show(block=False)
