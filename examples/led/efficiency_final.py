...
total_runtimes_fem_8 = np.array([0.18093156814575195, 0.19237661361694336, 0.744234561920166, 4.600370645523071, 37.01590156555176, 291.7129862308502, 2703.3561222553253, 4877.020454645157])
...
plt.loglog(l2_errors_fem, total_runtimes_fem_8, marker="o", label="Runtimes FEM", markersize=8, color="black")
plt.loglog(l2_errors_fem, ref_line_fem, "--", label="Slope = 1.5", color="black", alpha=0.5)

plt.loglog(l2_errors_led, total_runtimes_led, marker="o", label="Runtimes XLB-LED", markersize=8, color="blue")
...
print(np.max(total_runtimes_fem_8/total_runtimes_led))